...
def generate_speech(text, speaker_id, output_filename="output.wav"):
    """Generate speech from text using the specified speaker ID, following the model creator's approach"""
    try:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Generate Croatian speech using SpeechT5 (Creator\'s Approach)')
    ...
    parser.add_argument('--speaker_id', type=int, default=27, 
                        help='Speaker ID to use (0-49). The model creator used 27.')
    parser.add_argument('--output', type=str, default="creator_output.wav", 
